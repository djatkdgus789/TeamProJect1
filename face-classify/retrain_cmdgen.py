...
newmodel_path = "./workspace/face_shape_celebs3_aug_500"
newmodel_path1 = "./workspace/face_shape_celebs3_aug_500"

#where to find the retrain.py script?
#v2 also prints validation and train size
retrain_path = "./retrain_v2.py"
